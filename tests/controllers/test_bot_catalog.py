...
def test_bot_catalog_contains_random_and_heuristic_bots() -> None:
    ...
    assert ControllerType.HEURISTIC_V2_1_STRATEGIC in types
...
def test_bot_catalog_builds_expected_controllers() -> None:
    ...
    heuristic_v2_1 = build_bot_controller(ControllerType.HEURISTIC_V2_1_STRATEGIC, enable_bot_delay=False)
    ...
    assert isinstance(heuristic_v2_1, HeuristicV2_1StrategicBotController)
